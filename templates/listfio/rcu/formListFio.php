...
//        echo $count_empl;
    ...
    <div class="alert alert-danger">
        ...
        <form  role="form" id="formListFioAdd" method="POST" action="/str/listfio_rcu">
            <u> <b><?= $pasp ?>  <?= ($ch != 0 && $id_cardch!=0) ? ('смена '.$ch) : (($id_cardch==0)? 'подменный' : 'ежедневник') ?></b></u>
            <br><br><br>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <div class="checkbox checkbox-success">
                                <input id="checkbox_is_swing<?= $i ?>" type="checkbox" name="is_swing<?= $i ?>" value='1'>
                                <label for="checkbox_is_swing<?= $i ?>">
                                    Подменный
                                </label>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        <a href="/str/listfio_rcu/add">  <button type="button" class="btn btn-warning">Назад</button></a>
