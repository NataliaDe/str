...
<div class="container">
    <div class="col-lg-12">
        ...
        <form  role="form" id="editFormListFio" method="POST" action="/str/listfio_rcu/<?= $id_empl ?>">
                    ...
                    <div class="form-group">
                        <div class="checkbox checkbox-success">
                            ...
                            if ($is_swing == 1) {
                                ...
                                ?>
                                <input id="checkbox_is_swing" type="checkbox" name="is_swing" value='1' checked="">
                                <?php
                            } else {

                                ?>
                                <input id="checkbox_is_swing" type="checkbox" name="is_swing" value='1'>
                                <?php
                            }

                            ?>

                            <label for="checkbox_is_swing">
                                Подменный
                            </label>
                        </div>
                    </div>
