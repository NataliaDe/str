                ...
                <div class="row">
                    ...
                    <!--  <div class="col-lg-2">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control"  placeholder="КИП"  id="kip" name="kip">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="АСВ"  id="asv" name="asv">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="foam" placeholder="Пенообразователь, л" name="foam">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="powder" placeholder="Порошок, л" name="powder">
