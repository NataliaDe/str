...
<div class="container">
    <div class="alert alert-danger">
        ...
        <strong>Ошибка!</strong>Количество личного состава не соответствует введенным данным. Проверьте информацию и повторите попытку.
    </div>
</div>
...
<center>
        <div class="row">
            <div class="form-group">
                 <a href="/str/general" >  <button type="button" class="btn btn-warning">Назад</button></a>
            </div>
        </div>
    </center>
        ...
        <div class="row">
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-10 col-md-offset-4 col-lg-offset-3">
                     <a href="/str/general/1" >  <button type="button" class="btn btn-warning">Назад</button></a>
                </div>
            </div>
        </div>
    </div>
