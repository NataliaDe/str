...
?>
<!--<div class="col-lg-12">
    <center> <b>Информация по отсутствующим по др.причинам</b> </center>
</div>-->

<!--форма-->

<form  role="form" id="formFillCar" method="POST" action="/str/builder/basic/inf_other/3#result_page">
