...
Информация доступна за последние <b>3 дня</b>. Выбирается техника, которая на выбранную дату имеет состояние "ТО".

 <br><br>
<form  role="form"  method="POST" action="/str/v1/report/teh_to">
         ...
         <div class="col-lg-2">
            <div class="form-group">
                ...
                <select class="form-control" name="state_teh"   >
                    ...
                    <?php
                    $state_teh=array(0=>'ТО', 1=>'ТО-1', 2=>'ТО-2');
