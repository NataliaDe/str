    ...
    <div class="row">
        ...
        <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-multiple" name="position_search[]" multiple tabindex="4" data-placeholder="Все" >
                                        <option></option>
                                        <?php
                                          if (isset($_POST['position_search']) && !empty($_POST['position_search'])) {

                                            foreach ($position as $p) {
                                                if ( in_array($p['id'] , $_POST['position_search'])  ) {
