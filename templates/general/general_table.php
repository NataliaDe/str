    ...
    <div role="tabpanel" class="tab-pane active" id="general_table">
        ...
        <div class="col-lg-12">
            ...
            if (date(" H:i:s") < '00:00:00') {
                ?>
                <center> <u><b>Строевая записка ОПЧС c 08:00 <?= date("Y-m-d") ?> до 08:00  <?= date("Y-m-d", time() + (60 * 60 * 24)) ?>  </b></u></center>
                <?php
            } else {
                ?>
                <center> <u><b>Строевая записка ОПЧС c 08:00 <?= date("Y-m-d", time() - (60 * 60 * 24)) ?> до 08:00  <?= date("Y-m-d") ?>  </b></u></center>
                <?php
            }
            ?>
