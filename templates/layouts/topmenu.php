...
if ($_SESSION['login'] == 'spectator') {
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color: #add8fd" >
        ...
        <div class="container-fluid">
            ...
            <img src="/str/app/images/man.png" onclick="hideLeftmenu();" class="navbar-brand" id="imglogo1" data-toggle="tooltip" data-placement="left"><a href="/str/general/1" id="logo1">Строевая записка ver <?= VER ?> <!-- <span id="test-mode">опытная эксплуатация</span>--></a>
            ...
            <div class="navbar-collapse collapse " style="height: auto;" id="topmenu-collapse">
                ...
                <ul class="nav navbar-nav navbar-right" id="header-list">

                    <li><a href="#" class="item-menu" style="padding-right: 30px;">
                            <span  data-toggle="modal" data-target="#modal-get-rcu-str" >
                                <i class="fa fa-address-card-o fa-stack-2x" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Строевая записка РЦУРЧС"></i></span>
                        </a></li>
...
<!--         <span><i class="fa fa-search" aria-hidden="true" data-toggle="tooltip" data-placement="left" title="Поиск" target="_blank"></i></span>-->
                    ...
                    /* user authorized as spectator, can return  */ elseif (isset ($_SESSION['past_user'] ) && $_SESSION['login'] == 'spectator' && $_SESSION['psw'] == 'spectator') {
...
// }
                            ...
                            <li class="dropdown-submenu <?php echo (isset($convex_item['teh_to_sub'])) ? 'active-li-dropdown-submenu' : '' ?>">
                                <a tabindex="-1" href="/str/v1/report/teh_to" class="caret-spr_inf" target="_blank">Техника на ТО</a>
                            </li>
...
// }
                    ...
                    if ($_SESSION['ulevel'] == 1 && ($_SESSION['is_admin'] == 1 || $_SESSION['can_edit'] == 1)) {
                        ...
                        ?>
                        <li class="<?php echo (isset($convex_item['listfio_rcu'])) ? 'convex' : '' ?>"><a href="/str/listfio_rcu">Список смен(штат)</a></li>
                        <?php
                    }
                   ...
                   // if(isset( $_SESSION['uid']) &&  $_SESSION['uid'] == 1){
                        ...
                        <li class="dropdown unseen-notification <?php echo (isset($convex_item['notifications'])) ? 'convex' : '' ?>" id="li-notif">
                            <a href="#" class="dropdown-toggle " data-toggle="dropdown" id='notif-div'>

                                <?php
                                if (isset($convex_item['notifications'])) {

                                    ?>
                                    <i class="fa fa-envelope-open-o fa-lg open-notif"></i>
                                    <?php
                                } else {
                                ...
                                if (isset($unseen_notifications) && !empty($unseen_notifications)) {
                                    ...
                                    ?>
                                <span class="badge badge-success" id="number_notif" style="vertical-align: super; background-color: #4f73d9"><?= count($unseen_notifications) ?></span>
                                    <?php
                                }
                            ...
                            <div style="overflow: auto; max-height: 500px;" class="dropdown-menu dropdown-menu-notif">

                                <p id="show-after-read-all-notif" style="display:none">У вас нет новых уведомлений</p>
...
?>
                                    ...
                                    <a id="read_all_notify_button" href="javascript:" data-link="/str/readAllNotify" class="btn btn-cancel">
                                        Отметить
                                        как <br>прочитанные</a>
                                ...
                                ?>
                                <a href="/str/seeAllNotifications" class="btn btn-success">
                                    Смотреть
                                    все <br>уведомления</a>
                            </div>
                        </li>
                        <?php
                   // }
