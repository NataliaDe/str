...
$id_cp = array(8, 9, 12,5); //ROSN, EUP, AVIA
        ...
        <ol class="tree">
            <li class="menu-li">
                ...
                if ($_SESSION['ulevel'] == 1 && ($_SESSION['is_admin'] == 1 || $_SESSION['can_edit'] == 1)) {
                    if (isset($_SESSION['menu_rcu']) && !empty($_SESSION['menu_rcu'])) {

                        foreach ($_SESSION['menu_rcu'] as $value) {
                            $rcu_record = $value['record_id'];
                        }

                        ?>
                    <li class="menu-li">  <label for="folder-menu-rcu" id="label-checkbox">

                            <?php
                            if (isset($pasp_active) && $pasp_active == $rcu_record) {

                                ?>
                                <a href="/str/v1/card/<?= $rcu_record ?>/ch/<?= $duty_ch ?>/main" class="menu-a-pasp"   style="color: #f85a03 !important">
                                    <?php
                                } else {

                                    ?>
                                    <a href="/str/v1/card/<?= $rcu_record ?>/ch/<?= $duty_ch ?>/main" class="menu-a-pasp"   >
                                        <?php
                                    }
            ...
            ?>
                ...
                <li class="menu-li">  <label for="folder-menu-rosn" id="label-checkbox"><?= $name_podr ?></label>


                 <input type="checkbox" id="folder-menu-rosn"  class="input-li" checked="">
                    ...
                    <ol class="pasp-ul">
                        ...
                        foreach ($_SESSION['menurosn'] as $myrow) {
                            ...
                            ?>
                            <li class="menu-li"><label for="subfolder-menu-rosn">
